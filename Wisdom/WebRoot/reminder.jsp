...
<html>
	...
	<div class="main_bg">
		 <p class="about-title">Reminders</p>
	<div class="wrap">
	 <div class="blog">
	 	<!-- start main_content -->
		...
		<div class="rsidebar span_1_of_3">
				 	...
				 	<div class="Categories">
					 	<ul class="sidebar">
					 		...
					 		<!-- 静态数据 -->
				           	<div class="hover"><li><a href="#">Amoxicillin  Today  7:00pm</a></li></div>
				            <div class="hover"><li><a href="#">Dental check  Tomorrow  9:00am</a></li></div>
				            <div class="hover"><li><a href="#">Post-operative check-up  2015-09-01  9:30am</a></li></li>
				        </ul>
			        </div>
