	 ...
	 <div class="blog">
		...
		<div class="rsidebar span_1_of_3">
					 	...
					 	<ul class="sidebar">
						 		<div class="hover">
					           		...
					           		<div style="float:left;">
					           			<li><a href="#">Tom : 2015-7-10 2:30pm</a></li>
					           		</div>
						 		</div>
				        </ul>
			        ...
			        <div class="Categories">
					 	<ul class="sidebar">
						 		<div class="hover">
					           		...
					           		<div style="float:left;">
					           			<li><a href="#">Jerry : 2015-7-10 3:00pm</a></li>
					           		</div>
						 		</div>
				        </ul>
			        ...
			        <div class="Categories">
					 	<ul class="sidebar">
						 		<div class="hover">
					           		...
					           		<div style="float:left;">
					           			<li><a href="#">Flank : 2015-7-10 3:30pm</a></li>
					           		</div>
						 		</div>
				        </ul>
			        ...
			        <div class="sign_up sign_up1 ">
								<a href="doc_ReservationManage.jsp">Reservation Manage</a>
					</div>			        
			</div>
		<div class="clear"></div>
		<!-- end main_content -->
