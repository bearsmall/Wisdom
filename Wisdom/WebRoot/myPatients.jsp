...
<html>
	...
	<div class="main_bg">
		 <p class="about-title">Patient List</p>
	<div class="wrap">
	 <div class="blog">
	 	<!-- start main_content -->
					 		...
					 		<c:forEach items="${patientList}" var="patient" varStatus="status">
					 			<div class="hover">	
						 				<%-- <div style="float:right;">
					           			<a href="#"><img alt="" src="images/${patient.ID }ID44.png"></a>
					           			</div> --%>
				           			
				           			<!-- <div style="float:left;">	 -->			 			
						 				<li>
							 					<a href="patientInfoStatic.jsp">${patient.name }&nbsp;&nbsp;${patient.phoneNum }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img alt="" src="images/${patient.ID }ID44.png"></a>
						 				</li>
				 					<!-- </div> -->
					 			</div>
					 		</c:forEach>
