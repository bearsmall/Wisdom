...
<html>
	...
	<body>
		...
		<!------start-768px-menu---->
			...
			<div class="wrap">
					<div class="details">
						<h3 class="infomation">Name:<span class="patientInfo">${patient.name }</span></h3>
						<h3 class="infomation">Gender:<span class="patientInfo">${patient.gender }</span></h3>
						<h3 class="infomation">Birthday:<span class="patientInfo">${patient.birthday }</span></h3>
						<h3 class="infomation">Job:<span class="patientInfo">${patient.job }</span></h3>
						<h3 class="infomation">BirthPlace:<span class="patientInfo">${patient.birthPlace }</span></h3>
						<h3 class="infomation">Nation:<span class="patientInfo">${patient.nation }</span></h3>
						<h3 class="infomation">PhoneNumber:<span class="patientInfo">${patient.phoneNum }</span></h3>
						<h3 class="infomation">WorkAddress:<span class="patientInfo">${patient.workAddress }</span></h3>
						<h3 class="infomation">Introduction:</h3>
						<div class="det_text">
							<p class="para">${patient.introduction }</p>
							<div class="rqimage">		 			
							<img alt="" src="images/${patient.ID }ID280.png">
				 			</div>	
